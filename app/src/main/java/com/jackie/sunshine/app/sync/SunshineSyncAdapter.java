...
import com.jackie.sunshine.app.BuildConfig;
import com.jackie.sunshine.app.MainActivity;
import com.jackie.sunshine.app.R;
import com.jackie.sunshine.app.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static Account getSyncAccount(Context context) {
        ...
        Account newAccount = new Account(context.getString(R.string.app_name), context.getString
        ...
        if (manager.getPassword(newAccount) == null) {
             ...
             */
            if (!manager.addAccountExplicitly(newAccount, "", null)) return null;
    ...
    public static void syncImmediately(Context context) {
        ...
        ContentResolver.requestSync(getSyncAccount(context), context.getString(R.string
     ...
     */
    private void getWeatherDataFromJson(String forecastJsonStr, String locationSetting) throws
            JSONException {
        ...
        try {
            ...
            if (cVVector.size() > 0) {
                ...
                inserted = contentResolver.bulkInsert(WeatherEntry.CONTENT_URI,
                        cvArray);
    ...
    private void notifyWeather() {
        ...
        boolean needNotification = prefs.getBoolean(displayNotificationsKey, Boolean.valueOf(context.getString(R
                .string.pref_enable_notifications_default)));
        if (needNotification) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    Notification notification = new Notification.Builder(context).setSmallIcon(iconId).setContentTitle(title).setContentText(contentText).setContentIntent(pendingIntent).build();
