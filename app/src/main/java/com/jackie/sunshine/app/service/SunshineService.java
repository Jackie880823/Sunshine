...
package com.jackie.sunshine.app.service;
...
public class SunshineService extends IntentService {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ContentResolver locationResolver = getContentResolver();
    ...
    private void getWeatherDataFromJson(String forecastJsonStr, String locationSetting) throws
        ...
        try {
            ...
            if (cVVector.size() > 0) {
                ...
                inserted = getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI, cvArray);
            }
    ...
    public static class AlarmReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            sendIntent.putExtra(SunshineService.LOCATION_QUERY_EXTRA, intent.getStringExtra
